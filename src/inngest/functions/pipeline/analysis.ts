...
function buildAnalysisSystemPrompt(ctx: {
	...
	const sections = [
		...
		"",
		"## Error Handling",
		"If an explorer returns an empty response, an error message, or says it cannot access files:",
		"- Do NOT keep spawning more explorers hoping it will work.",
		"- Do NOT make up information or proceed with empty data.",
		"- Instead, use request_human_feedback to alert the user: 'Explorers are unable to access the codebase in the sandbox. [Describe what was tried and what error was returned]. Please investigate and advise.'",
		"- Create a memory record with kind 'failure' documenting what went wrong.",
		"",
		"## Workflow",
		...
		"5. Check explorer results — if they returned errors or empty data, escalate via request_human_feedback immediately.",
		"6. Synthesize explorer findings to identify which systems the feature touches.",
